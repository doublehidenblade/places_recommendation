...
exports.mapsDirLink = mapsDirLink;
exports.photoProxyUrl = photoProxyUrl;
exports.buildReason = buildReason;
function mapsDirLink(startLat, startLng, destLat, destLng) {
...
function truncateForSentence(text, maxLen) {
...
function selectTopReview(details) {
